        ...
        <tbody>
          <tr>
            ...
            <div id="content" style=" height: 400px;">
              <img id= "background" style="left: 0; opacity: 0.6; position: absolute; z-index: -1000;" src="${appConfig.baseUrl}/images/workplace.jpg">
            ...
            <footer style="text-align: center;">
              <a class="button" style = "text-decoration: none; font-family: sans-serif; font-weight: 200; padding: 10px; text-align: center; background-color: #17bb9c; border-radius: 10px; display: inline-block;
                  color: white"href="${context.link}">Click to verify your mail</a>
            </footer>
        </div>
          </tr>
        </tbody>
